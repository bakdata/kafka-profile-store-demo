...
public class AdjacencyList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.bakdata.recommender.avro.AdjacencyList.Builder newBuilder() {
    return new com.bakdata.recommender.avro.AdjacencyList.Builder();
  }
   ...
   * @return A new AdjacencyList RecordBuilder
   */
  public static com.bakdata.recommender.avro.AdjacencyList.Builder newBuilder(com.bakdata.recommender.avro.AdjacencyList.Builder other) {
    if (other == null) {
      return new com.bakdata.recommender.avro.AdjacencyList.Builder();
    } else {
      return new com.bakdata.recommender.avro.AdjacencyList.Builder(other);
    }
  }
   ...
   * @return A new AdjacencyList RecordBuilder
   */
  public static com.bakdata.recommender.avro.AdjacencyList.Builder newBuilder(com.bakdata.recommender.avro.AdjacencyList other) {
    if (other == null) {
      return new com.bakdata.recommender.avro.AdjacencyList.Builder();
    } else {
      return new com.bakdata.recommender.avro.AdjacencyList.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AdjacencyList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bakdata.recommender.avro.AdjacencyList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bakdata.recommender.avro.AdjacencyList other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.neighbors)) {
        this.neighbors = data().deepCopy(fields()[0].schema(), other.neighbors);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bakdata.recommender.avro.AdjacencyList.Builder setNeighbors(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bakdata.recommender.avro.AdjacencyList.Builder clearNeighbors() {
      neighbors = null;
